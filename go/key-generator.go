...
/*
 * [Example]:
 * $ go build key-generator.go
 * [Generate random data to file key.txt]:
 * $ ./key-generator -g key.txt 1000
 * [Read_Key range from 50 to 100]:
 * $ ./key-generator -r key.txt 50 100
 * [Get_Length]:
 * $ ./key-generator -l key.txt
 */
